...
DEFAULT_SERVICE_ICONS = {
    ...
    "deemix": "${di}/deemix.svg",
    "dockge": "${di}/dockge.svg",
    "earnapp": "${di}/earnapp.svg",
    "epicgames-freegames": "${di}/epicgames-freegames.svg",
    "filebrowser": "${di}/filebrowser.svg",
    "fileflows": "${di}/fileflows.svg",
    "firecrawl": "${di}/firecrawl.svg",
